...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_mask, segment_ids, label_ids, label_sent):
...
def convert_examples_to_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        features.append(
            InputFeatures(input_ids=input_ids, input_mask=input_mask, segment_ids=segment_ids, label_ids=label_ids, label_sent=sent)
        )
    return features
...
class BertForSentimentAnalysis(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.star_classifier = nn.Linear(config.hidden_size, self.num_star_labels)
        self.sent_classifier = nn.Linear(config.hidden_size, self.num_sent_labels)
        # Default regression loss function
        self.loss = 'mse'
        self.sigma = nn.Parameter(torch.ones(2, device="cuda"))
    ...
    def forward(
        ...
        if star_labels is not None:
            ...
            # classification
                ...
                # Lambda mode of concatenation
                # sent_loss = 0.1 * sent_loss
                # loss = 0.9 * loss
                # loss = loss.add(sent_loss)

                # Weighted mode of concatenation
...
def train(args, train_dataset, model, tokenizer, labels, pad_token_label_id):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {"input_ids": batch[0], "attention_mask": batch[1], "token_type_ids": batch[2], "star_labels": batch[3], "sent_labels": batch[4]}
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    dataset = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_sent_label_ids)
...
def main():
    args = get_args("./binary_data", output_dir="./output_mt_bert",model_name_or_path="bert-base-uncased", num_train_epochs=3.0, overwrite_output_dir=True, do_train=True)
    if (
...
"""
████████████████████████████████Iteration: 100%|████████████████████████████████████████████████████████████████Iteration: 100%|███████████████████████████████████████████████████████████████████████| 3899/3899 [14:20<00:00,  4.53it/s]
Epoch:  67%|█████████████████████████████████████████████████████▎                          | 2/3 [28:30<14:16, 856.24s/it]                                     12/07/2021 06:59:50 - INFO - __main__ -   Saving model checkpoint to ./output_mt_bert_new/checkpoint-10000
...
12/07/2021 06:59:57 - INFO - __main__ -   Saving optimizer and scheduler states to ./output_mt_bert_new/checkpoint-10000
Iteration: 100%|████████████████████████████| 3899/3899 [14:19<00:00,  4.53it/s]
Epoch: 100%|████████████████████████████████████████████████████████████████████Epoch: 100%|████████████████████████████████████████████████████████████████████████████████| 3/3 [42:50<00:00, 856.77s/it]
12/07/2021 07:06:08 - INFO - __main__ -    global_step = 11697, average loss = 0.2785322151332425
12/07/2021 07:06:08 - INFO - __main__ -   Saving model checkpoint to ./output_mt_bert_new
12/07/2021 07:06:13 - INFO - __main__ -   Loading features from cached file ./bert_data/cached_test_bert-base-uncased_128
12/07/2021 07:06:13 - INFO - __main__ -   ***** Running evaluation  *****
12/07/2021 07:06:13 - INFO - __main__ -     Num examples = 5504
12/07/2021 07:06:13 - INFO - __main__ -     Batch size = 8
Evaluating: 100%|█████████████████████████████| 688/688 [00:48<00:00, 14.27it/s]
12/07/2021 07:07:01 - INFO - __main__ -   ***** Eval results  *****
12/07/2021 07:07:01 - INFO - __main__ -     accuracy = 0.8780886627906976
12/07/2021 07:07:01 - INFO - __main__ -     loss = tensor(0.5473, device='cuda:0')
12/07/2021 07:07:01 - INFO - __main__ -     mean_absolute_error = 0.12191133720930232
12/07/2021 07:07:01 - INFO - __main__ -     mean_squared_error = 0.12191133720930232
